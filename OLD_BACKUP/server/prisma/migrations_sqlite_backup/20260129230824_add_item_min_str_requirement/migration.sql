...
INSERT INTO "new_ItemTemplate" ("baseValue", "category", "description", "elementalAffinity", "hardness", "id", "isTwoHanded", "name", "rarity") SELECT "baseValue", "category", "description", "elementalAffinity", "hardness", "id", "isTwoHanded", "name", "rarity" FROM "ItemTemplate";

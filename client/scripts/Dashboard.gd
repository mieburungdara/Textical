...
func _setup_layout() -> void:
    ...
    main_container.add_theme_constant_override("separation", GameTheme.SPACING_MEDIUM)
    main_container.position = Vector2(GameTheme.SPACING_MEDIUM, GameTheme.SPACING_MEDIUM)
    add_child(main_container)
    
    # Top row - Stats
    top_row = HBoxContainer.new()
    top_row.add_theme_constant_override("separation", GameTheme.SPACING_MEDIUM)
    ...
    middle_row.add_theme_constant_override("separation", GameTheme.SPACING_MEDIUM)
    ...
    bottom_row.add_theme_constant_override("separation", GameTheme.SPACING_MEDIUM)

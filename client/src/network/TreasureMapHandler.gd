...
# Socket reference
var _socket: SocketIOClient = null
...
func get_socket() -> SocketIOClient:
	# Try to get socket from various sources
	if has_node("/root/SocketIOClient"):
		return get_node("/root/SocketIOClient") as SocketIOClient
...
func get_maps():
	...
	_socket.emit("treasure:get_maps", {}, _on_get_maps_response)
...
func get_unused_maps():
	...
	_socket.emit("treasure:get_unused_maps", {}, _on_get_unused_maps_response)
...
func get_active_maps():
	...
	_socket.emit("treasure:get_active_maps", {}, _on_get_active_maps_response)
...
func use_map(map_id: int):
	...
	_socket.emit("treasure:use_map", {"mapId": map_id}, _on_use_map_response)
...
func check_dig(map_id: int):
	...
	_socket.emit("treasure:check_dig", {"mapId": map_id}, _on_check_dig_response)
...
func start_dig(map_id: int):
	...
	_socket.emit("treasure:start_dig", {"mapId": map_id}, _on_start_dig_response)
...
func complete_dig(map_id: int, task_id: int):
	...
	_socket.emit("treasure:complete_dig", {"mapId": map_id, "taskId": task_id}, _on_complete_dig_response)
...
func debug_create_map(rarity: String):
	...
	_socket.emit("treasure:debug_create", {"rarity": rarity}, _on_debug_create_response)
...
func get_dig_remaining_time() -> int:
	...
	return max(0, dig_finishes_at / 1000 - now)

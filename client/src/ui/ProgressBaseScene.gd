...
@onready var debug_log = get_node_or_null("DebugConsole")
...
func _ready():
	# BUG FIX: Use find_child to be hierarchy-independent
...
func _on_timer_finished():
	if status_label: status_label.text = "Processing..."
...
func _on_request_completed_base(endpoint, data):
	_log("Base received request_completed. Handing over to Child.")

...
@onready var resource_bars_container = $MarginContainer/HBoxContainer/ResourceBars
@onready var stat_summary_container = $MarginContainer/HBoxContainer/StatSummary
@onready var buffs_container = $MarginContainer/HBoxContainer/BuffsContainer
@onready var elemental_icon = $MarginContainer/HBoxContainer/ElementalIcon

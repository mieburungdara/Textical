...
INSERT INTO "new_RegionTemplate" ("description", "factionId", "gridX", "gridY", "id", "isSafeZone", "name", "regionTypeId", "regionalTaxRate", "specialization", "version", "visualType", "weatherOverride", "zoneColor", "zoneLevel", "zoneType") SELECT "description", "factionId", "gridX", "gridY", "id", "isSafeZone", "name", "regionTypeId", "regionalTaxRate", "specialization", "version", "visualType", "weatherOverride", "zoneColor", "zoneLevel", "zoneType" FROM "RegionTemplate";

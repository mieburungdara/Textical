...
INSERT INTO "new_ClassTemplate" ("atkGrowth", "defGrowth", "focus", "growthDesc", "hpGrowth", "id", "identity", "leadsTo", "mechanicDesc", "mpGrowth", "name", "parentClassId", "promotionReqLevel", "resourceType", "spdGrowth", "tier") SELECT "atkGrowth", "defGrowth", "focus", "growthDesc", "hpGrowth", "id", "identity", "leadsTo", "mechanicDesc", "mpGrowth", "name", "parentClassId", "promotionReqLevel", "resourceType", "spdGrowth", "tier" FROM "ClassTemplate";

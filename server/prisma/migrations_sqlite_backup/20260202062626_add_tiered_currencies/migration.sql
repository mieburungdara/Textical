/*
  ...
  - You are about to drop the column `amountDelta` on the `TransactionLedger` table. All the data in the column will be lost.
  - You are about to drop the column `newBalance` on the `TransactionLedger` table. All the data in the column will be lost.
...
CREATE TABLE "new_TransactionLedger" (
    ...
    "copperDelta" INTEGER NOT NULL DEFAULT 0,
    "copperBalance" INTEGER NOT NULL DEFAULT 0,
    "sourceId" INTEGER,
    "sourceType" TEXT,
...
INSERT INTO "new_User" ("currentRegion", "factionId", "gold", "guildId", "id", "isInTavern", "isKnockedOut", "knockedOutUntil", "lastPvpAction", "lastQuestResetAt", "lastTavernResetAt", "lastVisitedCityId", "lastVitalityUpdate", "maxInventorySlots", "maxVitality", "password", "premiumTierId", "pvpFlagged", "recoveryUntil", "tavernEntryAt", "tavernTimeSecondsToday", "username", "vitality") SELECT "currentRegion", "factionId", "gold", "guildId", "id", "isInTavern", "isKnockedOut", "knockedOutUntil", "lastPvpAction", "lastQuestResetAt", "lastTavernResetAt", "lastVisitedCityId", "lastVitalityUpdate", "maxInventorySlots", "maxVitality", "password", "premiumTierId", "pvpFlagged", "recoveryUntil", "tavernEntryAt", "tavernTimeSecondsToday", "username", "vitality" FROM "User";
DROP TABLE "User";

...
INSERT INTO "new_RegionTemplate" ("ambientSfxPack", "areaId", "description", "discoveryXp", "eliteSpawnChance", "factionId", "factionTributeRate", "flavorText", "gridX", "gridY", "id", "isDiscoveryPoint", "isSafeZone", "landmarkName", "maxPartyUnits", "minRequiredHeroLevel", "minRequiredUnits", "minimapIcon", "name", "regionTypeId", "regionalTaxRate", "reputationRequirement", "requiredAchievementId", "requiredLevel", "resourceModifier", "respawnPenaltyMult", "spawnRateMultiplier", "specialization", "teleportCostMultiplier", "traversalType", "version", "visualType", "weatherOverride", "zoneColor", "zoneLevel", "zoneType") SELECT "ambientSfxPack", "areaId", "description", "discoveryXp", "eliteSpawnChance", "factionId", "factionTributeRate", "flavorText", "gridX", "gridY", "id", "isDiscoveryPoint", "isSafeZone", "landmarkName", "maxPartyUnits", "minRequiredHeroLevel", "minRequiredUnits", "minimapIcon", "name", "regionTypeId", "regionalTaxRate", "reputationRequirement", "requiredAchievementId", "requiredLevel", "resourceModifier", "respawnPenaltyMult", "spawnRateMultiplier", "specialization", "teleportCostMultiplier", "traversalType", "version", "visualType", "weatherOverride", "zoneColor", "zoneLevel", "zoneType" FROM "RegionTemplate";

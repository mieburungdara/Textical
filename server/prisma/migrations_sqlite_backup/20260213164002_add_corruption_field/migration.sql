...
INSERT INTO "new_RegionTemplate" ("ambientSfxPack", "areaId", "blessingType", "description", "discoveryXp", "elementalAffinity", "eliteSpawnChance", "factionId", "factionTributeRate", "flavorText", "gridX", "gridY", "id", "innRecoveryRate", "isDiscoveryPoint", "isSafeZone", "landmarkName", "marketDemandIndex", "maxPartyUnits", "minRequiredHeroLevel", "minRequiredUnits", "minimapIcon", "name", "regionTypeId", "regionalTaxRate", "reputationRequirement", "requiredAchievementId", "requiredLevel", "resourceModifier", "resourceScarcity", "respawnPenaltyMult", "spawnRateMultiplier", "specialization", "teleportCostMultiplier", "terrainAttackMod", "terrainDefenseMod", "traversalType", "version", "visualType", "weatherOverride", "zoneColor", "zoneLevel", "zoneType") SELECT "ambientSfxPack", "areaId", "blessingType", "description", "discoveryXp", "elementalAffinity", "eliteSpawnChance", "factionId", "factionTributeRate", "flavorText", "gridX", "gridY", "id", "innRecoveryRate", "isDiscoveryPoint", "isSafeZone", "landmarkName", "marketDemandIndex", "maxPartyUnits", "minRequiredHeroLevel", "minRequiredUnits", "minimapIcon", "name", "regionTypeId", "regionalTaxRate", "reputationRequirement", "requiredAchievementId", "requiredLevel", "resourceModifier", "resourceScarcity", "respawnPenaltyMult", "spawnRateMultiplier", "specialization", "teleportCostMultiplier", "terrainAttackMod", "terrainDefenseMod", "traversalType", "version", "visualType", "weatherOverride", "zoneColor", "zoneLevel", "zoneType" FROM "RegionTemplate";

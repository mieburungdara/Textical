...
const ErrorCodes = {
    ...
    // Crafting Fail System Errors
    CRAFT_FAIL_SAFE: 'CRAFT_FAIL_SAFE',
    CRAFT_FAIL_QUALITY_DROP: 'CRAFT_FAIL_QUALITY_DROP',
    CRAFT_FAIL_DESTROYED: 'CRAFT_FAIL_DESTROYED',
    CRAFT_FAIL_CATASTROPHIC: 'CRAFT_FAIL_CATASTROPHIC',
    CRAFT_SKILL_NOT_FOUND: 'CRAFT_SKILL_NOT_FOUND',
    CRAFT_INVALID_PROFESSION: 'CRAFT_INVALID_PROFESSION',
    CRAFT_RANK_TOO_LOW: 'CRAFT_RANK_TOO_LOW',
    CRAFT_NO_FAIL_SYSTEM: 'CRAFT_NO_FAIL_SYSTEM',

...
func _on_new_game_pressed():
	...
	# 2. Add Initial Novice Character
	var novice = load("res://data/units/heroes/Novice.tres")
	GlobalGameManager.owned_heroes.append(novice)
	GlobalGameManager.player_party[Vector2i(1, 1)] = novice 
	
	# 3. Create Initial Save
